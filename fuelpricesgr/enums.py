...
class Prefecture(enum.Enum):
    ...
    BOEOTIA = 'BOEOTIA', "ΒΟΙΩΤΙΑΣ", r'ΝΟΜΟ\s?Σ\s{1,2}Β\s?Ο\s?Ι\s?Ω\s?ΤΙ\s?Α\s?Σ'
    GREVENA = 'GREVENA', "ΓΡΕΒΕΝΩΝ", r'ΝΟΜΟ\s?Σ\s{1,2}Γ\s?ΡΕ\s?Β\s?Ε\s?Ν\s?Ω\s?Ν'
    ...
    ZAKYNTHOS = 'ZAKYNTHOS', "ΖΑΚΥΝΘΟΥ", r'ΝΟΜ\s?ΟΣ Ζ\s?ΑΚΥ\s?ΝΘΟ\s?Υ'
    ELIS = 'ELIS', "ΗΛΕΙΑΣ", r'ΝΟΜ\s?Ο\s?Σ\s{1,2}ΗΛ\s?Ε\s?ΙΑΣ'
    IMATHIA = 'IMATHIA', "ΗΜΑΘΙΑΣ", r'ΝΟΜΟΣ\sΗΜΑΘ\s?ΙΑΣ'
    HERAKLION = 'HERAKLION', "ΗΡΑΚΛΕΙΟΥ", r'ΝΟΜ\s?ΟΣ ΗΡΑ\s?Κ\s?Λ\s?ΕΙΟΥ'
    ...
    CORINTHIA = 'CORINTHIA', "ΚΟΡΙΝΘΙΑΣ", r'ΝΟΜΟΣ\s{1,2}ΚΟΡ\s?Ι\s?Ν\s?Θ\s?Ι\s?Α\s?Σ'
    ...
    LESBOS = 'LESBOS', "ΛΕΣΒΟΥ", r'ΝΟΜ\s?ΟΣ ΛΕ\s?ΣΒΟΥ'
    LEFKADA = 'LEFKADA', "ΛΕΥΚΑΔΟΣ", r'ΝΟΜΟ\s?Σ\s{1,2}ΛΕΥΚΑ\s?ΔΟΣ'
    MAGNESIA = 'MAGNESIA', "ΜΑΓΝΗΣΙΑΣ", r'ΝΟΜΟΣ\s{1,2}ΜΑ\s?ΓΝ\s?ΗΣΙΑ\s?Σ'
    ...
    SERRES = 'SERRES', "ΣΕΡΡΩΝ", r'ΝΟΜ\s?ΟΣ\s{1,2}ΣΕΡΡ\s?Ω\s?Ν'
    TRIKALA = 'TRIKALA', "ΤΡΙΚΑΛΩΝ", r'ΝΟΜ\s?Ο\s?Σ Τ\s?Ρ\s?ΙΚΑΛΩ\s?Ν'
    ...
    CHALKIDIKI = 'CHALKIDIKI', "ΧΑΛΚΙΔΙΚΗΣ", r'ΝΟΜΟ\s?Σ ΧΑΛΚΙ\s?Δ\s?ΙΚΗΣ'
